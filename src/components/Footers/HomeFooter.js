      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between md:items-start space-y-8 md:space-y-0 md:space-x-8">
        ...
        <div className="flex-1 text-center md:text-left min-w-[150px]">
          ...
          <p className={`text-sm ${textColorClass}`}>
            Innovation at its best, delivering powerful solutions for your business.
          </p>
        </div>
        ...
        <div className="flex-1 text-center md:text-right w-full md:w-auto min-w-[200px]">
            ...
            <div className="mb-6">
                ...
                <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-2 max-w-sm mx-auto md:mx-0">
                    <input
                        type="email"
                        placeholder="Enter your email"
                        className={`flex-grow p-2 rounded-md border ${inputBorderClass} ${inputBgColorClass} focus:outline-none focus:ring-2`}
                    ...
                    <button
                        type="submit"
                        className={`px-4 py-2 rounded-md font-semibold ${buttonBgClass} ${buttonTextColor} transition-colors duration-200`}
                    >
                        Subscribe
                    </button>
                </form>
                {subscribeMessage && (
                    <p className={`mt-2 text-sm ${subscribeMessage.includes('Thank you') ? 'text-green-500' : 'text-red-500'}`}>
                        {subscribeMessage}
                    </p>
                )}
            </div>
